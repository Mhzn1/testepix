...
import { FaGithub, FaLinkedin, FaEnvelope, FaBroom,  FaMoon} from 'react-icons/fa';
  ...
  return (
    <div className="App">
      ...
      <div className="history-container">
        ...
        {showHistory ? (
          <>
            <h3 style={{ textAlign: 'center' }}>QR Codes Salvos:</h3>
            <ToastContainer
              position="top-right"
              autoClose={3000}
          ...
          {historicoQRCode.slice(0, 5).map((item, index) => (
            <div className="qr-code-item" key={index}>
              <div className="qr-code-data">
                <p><strong>Nome:</strong> {item.merchantName}</p>
                <p><strong>Chave:</strong> {item.pixKey}</p>
                <p><strong>Valor:</strong> {formatCurrency(item.transactionAmount)}</p>
              </div>
      ...
      {selectedRecipient && (
        ...
        <a href="https://github.com/Mhzn1" className="icon github" target="_blank" rel="noopener noreferrer">
          <FaGithub />
        </a>
      <a href="https://www.linkedin.com/in/matheus-kunst-trasel-b3894a200/" className="icon linkedin" target="_blank" rel="noopener noreferrer">
        <FaLinkedin />
        </a>        <a href="mailto:matheus.mhzn1@gmail.com" className="icon email" target="_blank" rel="noopener noreferrer">
        <FaEnvelope />
      </a>
    </div>
    </div>
